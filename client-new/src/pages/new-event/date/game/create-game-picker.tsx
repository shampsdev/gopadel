...
export const CreateGameYearMonthPick = () => {
  const navigate = useNavigate();
  useTelegramBackButton({ showOnMount: true, hideOnUnmount: true });

  const { selectedDate, setDateFromCalendar } = useCreateGameStore();
  ...
  // Генерируем список годов (текущий год и 9 лет вперед)
  ...
  return (
    <div className="flex flex-col gap-[40px] pb-[200px]">
      <div className="flex flex-col gap-6">
        ...
        {/* Отображение выбранной даты и кнопка "Готово" */}
