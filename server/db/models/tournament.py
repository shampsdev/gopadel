...
class Tournament(Base):
    ...
    club_id: Mapped[UUID] = mapped_column(ForeignKey("clubs.id"), nullable=False)
    tournament_type: Mapped[str] = mapped_column(String(100), nullable=False)
    ...
    club: Mapped["Club"] = relationship("Club", back_populates="tournaments")
